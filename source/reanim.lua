...
local CracktroFrameText = "Krystal Dance Edition V" .. UhhhhhhVersion
local UIMainWindow, WindowContent do
	...
	TopBarText.Text = "Krystal Dance Edition | v" .. UhhhhhhVersion
	...
	if (SaveData.SkipIntro and math.random(2) == 1) or os.date("%m %d") ~= "04 01" then
		local quotes = {
			...
			"Krystal Dance Edition | v" .. UhhhhhhVersion,
		}
...
local function CreateHumanoidCharacter()
	...
	char.Name = "(C) Krystal Dance Edition V" .. UhhhhhhVersion
...
function HatReanimator.Start()
	...
	local function CreatePlaceholder(hat)
		...
		if h and h:IsA("BasePart") then
			...
			p.CanQuery = false
			p.Transparency = 0.75
			p.Name = "(C) Krystal Dance Edition V" .. UhhhhhhVersion .. " :: HAT PLACEHOLDER"
