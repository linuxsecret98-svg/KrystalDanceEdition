...
if _G.KrystalDanceLoaded then return end
_G.KrystalDanceLoaded = true

local KrystalDanceVersion = "1.0.9 BETA"
...
if not game:IsLoaded() then
	...
	notLoaded.Text = "Krystal Dance Edition is waiting for the game to load"
	game.Loaded:Wait()
	for i=1, 60 do
...
local IsKrystalDanceFullyLoaded = false
...
local SaveData = {}
do
	pcall(makefolder, "KrystalDanceEdition")
	pcall(writefile, "KrystalDanceEdition/.nomedia", "")
	local SaveDataFilename = "KrystalDanceEdition/tree.ehehetilde"
	...
	pcall(makefolder, "KrystalDanceEdition/Assets")
	pcall(makefolder, "KrystalDanceEdition/Modules")
	pcall(makefolder, "KrystalDanceEdition/Muzik")
	pcall(makefolder, "KrystalDanceEdition/BuiltinModules")
	pcall(makefolder, "KrystalDanceEdition/Content")
	pcall(makefolder, "KrystalDanceEdition/Content/Anims")
	pcall(makefolder, "KrystalDanceEdition/Content/Sounds")
	pcall(makefolder, "KrystalDanceEdition/Content/Images")
	pcall(makefolder, "KrystalDanceEdition/Content/Models")
	pcall(makefolder, "KrystalDanceEdition/Content/Unknown")
end
...
do
	...
	for _,rfile in AllFileNames do
		local fil = "KrystalDanceEdition/Assets/" .. rfile
	...
	if theresassetsmissing then
		...
		local downloadfile = function(meta)
			local fil = "KrystalDanceEdition/Assets/" .. meta.name
		...
		task.wait(0.5)
		local s, assetsof = pcall(game.HttpGet, game, "https://api.github.com/repos/STEVE-916-create/Krystal Dance Edition/contents/uiassets/")
...
Util.GetCDNAsset = function(filename)
	local path = "KrystalDanceEdition/Assets/" .. filename
...
MusicPlayer.Database = {
	{"KrystalDanceEdition/Assets/dm_afterburner.ft2.mp3", "Dubmood - Afterburner"},
	{"KrystalDanceEdition/Assets/dm_robotadventure.ft2.mp3", "Dubmood & Zabutom - Robot Adventure Remix"},
	{"KrystalDanceEdition/Assets/4m_brokenheart.ft2.mp3", "4-Mat - <3 Broken Heart <3"},
	{"KrystalDanceEdition/Assets/fr_brokenheart.ft2.mp3", "Hoster's FR - Alternate Broken Heart"},
	{"KrystalDanceEdition/Assets/dm_change.ft2.mp3", "Dubmood - Change (Radio Edit)"},
	{math.random() < 0.5 and "KrystalDanceEdition/Assets/dm_deadscene2024.ft2.mp3" or "KrystalDanceEdition/Assets/dm_deadscene2024alt.ft2.mp3", "Dubmood - The Scene is Dead 2024"},
	{"KrystalDanceEdition/Assets/dm_e1m777.ft2.mp3", "Dubmood & MBR - E1M777"},
	{"KrystalDanceEdition/Assets/dm_haze.ft2.mp3", "Dubmood - Haze (Keygen 13 Edit)"},
	{"KrystalDanceEdition/Assets/dm_haze2.ft2.mp3", "Dubmood - Haze Keygen 2"},
	{"KrystalDanceEdition/Assets/dm_iostesso.ft2.mp3", "Dubmood - Io Stesso"},
	{"KrystalDanceEdition/Assets/dm_keygen3.ft2.mp3", "Dubmood - Keygen 3"},
	{"KrystalDanceEdition/Assets/dm_keygen8.ft2.mp3", "Dubmood - Keygen 8"},
	{"KrystalDanceEdition/Assets/dm_keygen18.ft2.mp3", "Dubmood - Keygen 18"}, -- intro music
	{"KrystalDanceEdition/Assets/dm_keygen19.ft2.mp3", "Dubmood - Keygen 19"},
	{"KrystalDanceEdition/Assets/dm_keygen20.ft2.mp3", "Dubmood - Keygen 20"},
	{"KrystalDanceEdition/Assets/dm_keygen21alt.ft2.mp3", "Dubmood - Keygen 21"},
	{"KrystalDanceEdition/Assets/dm_keygen21.ft2.mp3", "Dubmood - Keygen 21 (Installer Edit)"},
	{"KrystalDanceEdition/Assets/dm_keygen22.ft2.mp3", "Dubmood - Keygen 22"},
	{"KrystalDanceEdition/Assets/dm_keygen23.ft2.mp3", "Dubmood - Keygen 23"},
	{"KrystalDanceEdition/Assets/dm_keygen30.ft2.mp3", "Dubmood - Keygen 30"},
	{"KrystalDanceEdition/Assets/dm_keygen31.ft2.mp3", "Dubmood - Keygen 31"},
	{"KrystalDanceEdition/Assets/fr_keygen31.ft2.mp3", "Hoster's FR - Alternate Keygen 31"},
	{"KrystalDanceEdition/Assets/dm_laparade.ft2.mp3", "Dubmood & MBR - La Parade"},
	{"KrystalDanceEdition/Assets/dm_reztro4.ft2.mp3", "Dubmood - Rez Cracktro #4"},
	{"KrystalDanceEdition/Assets/dm_unaseraariccione.ft2.mp3", "Dubmood - Una Sera A Riccione"},
}
pcall(function()
	local future = table.clone(MusicPlayer.Database)
	if isfile("KrystalDanceEdition/Muzik/nobuiltin") then
		table.clear(future)
	end
	for _,file in listfiles("KrystalDanceEdition/Muzik") do
...
local function SetUITheme(index)
	...
	if index == #UIThemes + 1 then
		if type(_G.KrystalDanceTheme) == "table" and getmetatable(_G.KrystalDanceTheme) == nil then
			processtable(_G.KrystalDanceTheme)
...
local CracktroFrameText = "Krystal Dance Edition V" .. KrystalDanceVersion
local UIMainWindow, WindowContent do
	...
	TopBarText.Text = "Krystal Dance Edition | v" .. KrystalDanceVersion
	...
	if (SaveData.SkipIntro and math.random(2) == 1) or os.date("%m %d") ~= "04 01" then
		local quotes = {
			"Ohhhhhh Re-create | v" .. KrystalDanceVersion,
			"jumpscare",
			"you'll never see it coming",
			Player.Name .. "'s Krystal Dance Session",
			...
			"Krystal Dance Edition | v" .. KrystalDanceVersion,
		}
...
RunService:BindToRenderStep("KrystalDance_Render" .. Util.RandomString(), Enum.RenderPriority.Last.Value - 69, function(dt)
	_totalrendertime += dt
...
do -- homepage
	...
	local quotes = {
		...
		"You are going to love Krystal Dance Edition, I just know it.",
	...
	AddToRenderStep(function(t, dt)
		if Util.IsGuiVisible(CracktroFrame) then
			...
			local textsel = t % 9
			if IsKrystalDanceFullyLoaded then
				textsel = t % 12
			end
			textsel //= 3
...
CracktroFrame.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		if _totalrendertime < 1 or not IsKrystalDanceFullyLoaded then return end
...
task.spawn(function()
	...
	local AsciiTextarts = {
		...
		{ -- omg hi steveee-
			...
			"lilili:ZSXS: XSX :X##Z:ilil!. welcome to Krystal Dance Edition .!i",
			"EEEEEE:YLkk2S2SXSXSXZP:EEEEEi:                  :iEE",
			"%%%%%%%;vnvkkkk2S2vnv;%%%%%%%%%oooooooooooooooo%%%%%",
		},
		{
			"  Get Krystal Dance Edition today! Feel the difference!       ",
			"           (-_-)         EPIC!    (^~^)   .vv=E ",
			"       ()-(:::::)-()         .()-(:::::)-()'    ",
			"LAME!  || |.....| ||      3=^^'  /...../        ",
			"       YP |     | YP            (     )   COOL! ",
			"      Without Krystal Dance Edition   vs.   With Krystal Dance Edition      ",
		},
		{
			...
			"68 68 68 68 Krystal Dance Edition  68 68 68 68 55 68 68",
		...
		{
			"+-[ Krystal Dance Edition Reanimate ]-----------------[#]-+",
			"|    ___                                    |",
		...
		{
			"  local oldsec = 0          .-+=* Krystal Dance Edition *=+-. ",
		...
		},
		{
			...
			"the dev portal cuz Krystal Dance Edition.                        ",
			"                                                   ",
			"\"it's not fast it's shit\"                          ",
			"Believe me friend, its fuckingly fast, you don't ev",
		},
		{
			"Krystal Dance Edition  https://discord.gg/NASNUKRBVM  Krystal Dance Edition",
			"Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition STEVETHEREALONE",
			"Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition STEVETHEREALONE Krystal Dance Edition",
			"Krystal Dance Edition Krystal Dance Edition STEVETHEREALONE Krystal Dance Edition Krystal Dance Edition",
			"Krystal Dance Edition STEVETHEREALONE Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition",
			"STEVETHEREALONE Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition Krystal Dance Edition",
		},
	}
...
UI.CreateText(MainPage, `Reanimate V{KrystalDanceVersion}, By STEVE :D`, 15, Enum.TextXAlignment.Right)
...
local function CreateHumanoidCharacter()
	...
	char.Name = "(C) Krystal Dance Edition V" .. KrystalDanceVersion
...
-- empyrean-like thing
local _G_Krystal Dance Edition = {}
-- jjsloit didnt have _G, just making sure if 100% unc execs dont have this even
pcall(function() _G.Krystal Dance Edition = _G_Krystal Dance Edition end)
_G_Krystal Dance Edition.BindableEvent = Util.Instance("BindableEvent") -- not used 3:
...
do
	...
	do -- Control
		...
		RunService:BindToRenderStep("KrystalDance_Control", Enum.RenderPriority.Input.Value + 1, function(dt)
	...
	do -- Camera
		...
		RunService:BindToRenderStep("KrystalDance_Camera", Enum.RenderPriority.Camera.Value + 1, function(dt)
...
Util.PredictionFling = function(target)
	if typeof(target) == "Instance" then
		...
		if target and target:IsA("BasePart") then
			...
			local oldpos = target:GetAttribute("_KrystalDance_LastPosition")
			if not oldpos then
				oldpos = target.Position
				target:SetAttribute("_KrystalDance_LastPosition", oldpos)
			end
			if (target.Position - oldpos).Magnitude > 200 then
				target:SetAttribute("_KrystalDance_LastPosition", nil)
				return cf, true
			end
			return cf, false
		end
...
function LimbReanimator.Start()
	...
	local LimbMapping = loadstring(readfile("KrystalDanceEdition/BuiltinModules/d_limbmap.lua"))()
		...
		for _,v in Player.Character:GetChildren() do
			if v:IsA("Accessory") then
				...
				if handle and handle:IsA("BasePart") then
					if handle:GetAttribute("_KrystalDance_HasCollide") then
...
function HatReanimator.Start()
	...
	local HatMeshDatabase, HatNameDatabase, HatKnownAccessoriesDatabase = loadstring(readfile("KrystalDanceEdition/BuiltinModules/d_hatsmap.lua"))()
	...
	local function CreatePlaceholder(hat)
		...
		if h and h:IsA("BasePart") then
			...
			p.CanQuery = false
			p.Transparency = 0.75
			p.Name = "(C) Krystal Dance Edition V" .. KrystalDanceVersion .. " :: HAT PLACEHOLDER"
	...
	local function SetUACFrameNetless(handle, dt, newcf, tvel, fling, spin)
		...
		local aligned = true
		local lastcf = handle:GetAttribute("_KrystalDance_LastPosition")
		local claimtime = handle:GetAttribute("_KrystalDance_ClaimTime")
		...
		handle:SetAttribute("_KrystalDance_LastPosition", lastcf)
		handle:SetAttribute("_KrystalDance_ClaimTime", claimtime)
		return aligned
	end
		...
		for _,hat in hats do
			...
			if handle and handle:IsA("BasePart") then
				...
				if handle.CanCollide then
					collidable += 1
					handle:SetAttribute("_KrystalDance_HasCollide", true)
				end
	...
	local function OnCharacter(character)
		...
		for _,hat in CharHats do
			...
			if handle and handle:IsA("BasePart") then
				...
				handle:SetAttribute("_KrystalDance_HasCollide", false)
			end
		end
	...
	while not Reanimate.Stopping do
		...
		workspace.FallenPartsDestroyHeight = 0/0
		SetSimulationRadius()
		debug.profilebegin("Krystal Dance Edition > CharacterCheck")
		local ReanimOkay = false
		...
		debug.profileend()
		debug.profilebegin("Krystal Dance Edition > BaseParts")
		...
		debug.profileend()
		debug.profilebegin("Krystal Dance Edition > ReanimOkay")
		local t = os.clock()
		local slocked = {}
		if ReanimOkay then
			local dt = RunService.Heartbeat:Wait()
			...
			if RCRootPart then
				...
				local handlethese = {}
				debug.profilebegin("Krystal Dance Edition > CharTools")
				for _,v in CharTools do
					...
					if not v:GetAttribute("_Krystal Dance Edition_ActivateConn") then
						v:SetAttribute("_Krystal Dance Edition_ActivateConn", true)
						v.Activated:Connect(function()
							v:SetAttribute("_Krystal Dance Edition_Activate", true)
						end)
					end
					if v:GetAttribute("_Krystal Dance Edition_Activate") then
						v:SetAttribute("_Krystal Dance Edition_Activate", nil)
						toolactivate = true
						toolactivated = v
					end
					v.Enabled = true
				...
				if #CharTools > 0 and HatReanimator.ToolHolding then
					...
					if HatReanimator.ToolAnimMethod == 1 then
						...
						if toolactivate then
							local newuse = FakeTool:GetAttribute("_Krystal Dance Edition_Sword_CD") or 0
							local lastuse = FakeTool:GetAttribute("_Krystal Dance Edition_Sword_LU") or 0
							if t > newuse then
							...
							FakeTool:SetAttribute("_Krystal Dance Edition_Sword_CD", newuse)
							FakeTool:SetAttribute("_Krystal Dance Edition_Sword_LU", lastuse)
						end
					end
				else
					local FakeTool = ReanimCharacter:FindFirstChildOfClass("Tool")
				...
				debug.profileend()
				debug.profilebegin("Krystal Dance Edition > FlingLogic")
				...
				if flingtarget then
					...
					if HatReanimator.FlingMethod == 1 then
						...
						for _,hat in CharHats do
							local handle = hat:FindFirstChild("Handle")
							if handle and handle:IsA("BasePart") and handle:GetAttribute("_KrystalDance_HasCollide") and IsNetworkOwner(handle) then
				...
				debug.profileend()
				debug.profilebegin("Krystal Dance Edition > Alignments")
				for _,hat in CharHats do
					local handle = hat:FindFirstChild("Handle")
					if handle and handle:IsA("BasePart") then
						handle.CanCollide = false
		...
		debug.profilebegin("Krystal Dance Edition > Placeholders")
		for _,ref in HatRefs do
			local ph = ref.PH
			if ph then
		...
		debug.profileend()
		RunService.PreRender:Wait()
		debug.profilebegin("Krystal Dance Edition > PreRender")
...
_G_Krystal Dance Edition.Fling = function(part)
	...
	function Animator:Step(t)
		...
		if rig and track then
			...
			for name,joint in jointmap do
				...
				if weight == 1 then
					joint.Transform = cf
					-- SERVER SYNC: replicate joint transform ke server
					Util.SetMotor6DTransform(joint, cf)
				elseif weight ~= 0 then
					local blended = joint.Transform:Lerp(cf, weight)
					joint.Transform = blended
					-- SERVER SYNC: replicate blended joint transform ke server
					Util.SetMotor6DTransform(joint, blended)
				end
			end
		end
	end
...
local function AssetGetPathFromFilename(filename)
	...
	return "KrystalDanceEdition/Content/" .. filetype .. filename
end
...
local function AssetDownload(filename)
	local source = "https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/content/" .. filename
	...
	if source:sub(1, 7) == "MARKET/" then
		source = "https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/community/" .. source:sub(8)
	end
...
do
	...
	function ContextActions:RunBinding(caac, input)
		local s, result = xpcall(caac.Callback, function(m)
			warn(debug.traceback("Krystal Dance Edition :: Custom ContextActions Error - " .. m))
...
local Krystal Dance EditionFire = UI.CreateText(CreditsPage, "", 12, Enum.TextXAlignment.Center)
Util.ForceTextSize(Krystal Dance EditionFire)
UI.CreateText(CreditsPage, "Reanimate by STEVE :D", 15, Enum.TextXAlignment.Right)
local Krystal Dance EditionFiret = UI.CreateSlider(CreditsPage, "Transparency", 0.25, 0, 1, 0)
local Krystal Dance EditionFirep = {}
for i=1, 64 do
	table.insert(Krystal Dance EditionFirep, {i / 64, 0.98 + math.random() * 0.04, math.random(), math.random() - 0.5})
end
local Krystal Dance EditionFirea = {
...
local Krystal Dance EditionFirex = #Krystal Dance EditionFirea[1]
local Krystal Dance EditionFirey = #Krystal Dance EditionFirea
AddToRenderStep(function(t, dt)
	local radius = 0.1
	local ratio = (Krystal Dance EditionFirey / Krystal Dance EditionFirex) * 1.75
	if Util.IsGuiVisible(Krystal Dance EditionFire) then
		local tr = math.clamp(Krystal Dance EditionFiret.Value, 0, 1)
		local pp = {}
		for _,v in Krystal Dance EditionFirep do
			v[1] += dt * v[2]
			if v[1] >= 1 then
		...
		local aa = {}
		for y=1, Krystal Dance EditionFirey do
			local a = ""
			for x=1, Krystal Dance EditionFirex do
				local b = Krystal Dance EditionFirea[y]:sub(x, x)
				if b == " " and tr < 0.1 then
					a ..= " "
				else
					local bright = 0
					local x1, y1 = x / Krystal Dance EditionFirex, y / Krystal Dance EditionFirey
					for _,v in pp do
						local x2, y2 = v[2], v[3]
		...
		Krystal Dance EditionFire.Text = table.concat(aa, "\n")
		pp = nil
	end
end)
...
do
	local quotes = {
		...
		"\"Tired of your hats phasing through people? Krystal Dance Edition turns that fact upside-down!\"",
...
UI.CreateText(CreditsPage, "If you want to add content to Krystal Dance Edition, like Dances or Movesets, go to <font color=\"#4444FF\">this thing</font>.", 15, Enum.TextXAlignment.Center).InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		Util.UINotify("Link copied!")
		pcall(setclipboard, "https://github.com/STEVE-916-create/Krystal Dance Edition/")
	end
end)
UI.CreateSeparator(CreditsPage)
...
task.spawn(function()
	...
	xpcall(function()
		local logs = game:HttpGet("https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/CHANGELOGS")
...
local function _contentgetgithubraw(path)
	...
	local s, resp = pcall(request, {
		Method = "GET",
		Url = "https://api.github.com/repos/STEVE-916-create/Krystal Dance Edition/contents/content/" .. path,
		Headers = {
	...
	s, resp = pcall(request, {
		Method = "GET",
		Url = "https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/content/" .. path,
	})
	if s and resp and resp.StatusCode == 200 then
		return resp.Body
	end
...
local function ForceModuleReload(force)
	IsKrystalDanceFullyLoaded = false
	...
	if force ~= "SKIPHASH" then
		xpcall(function()
			local s, resp = pcall(request, {
				Method = "GET",
				Url = "https://api.github.com/repos/STEVE-916-create/Krystal Dance Edition/contents/content/",
			})
			if s and resp and resp.StatusCode == 200 then
						...
						if file.name and file.sha then
							if SaveData.ContentHash[file.name] ~= file.sha then
								...
								if table.find(filesofbuiltins, file.name) then
									local path = "KrystalDanceEdition/BuiltinModules/" .. file.name
									if isfile(path) then
	...
	for i,x in filesofbuiltins_d do
		...
		local path = "KrystalDanceEdition/BuiltinModules/" .. x
		local exist = false
	...
	for i,x in filesofbuiltins_m do
		...
		xpcall(function()
			local func, comperr = loadstring(data, "Krystal Dance Edition :: VANILLA " .. x)
			if func then
	...
	for _,path in listfiles("KrystalDanceEdition/Modules/") do
		if isfile(path) then
			local x = path:sub(23)
			xpcall(function()
				...
				local func, comperr = loadstring(data, "Krystal Dance Edition :: " .. x)
				if func then
					local names, logging = AddModules(func())
	...
	IsKrystalDanceFullyLoaded = true
	CurrentDance = nil
	if not Reanimate.Character then return end
	Reanimate.CreateCharacter()
end
...
clearcontenthash.Activated:Connect(function()
	...
	elseif clearcontenthashclicks == 3 then
		...
		pcall(cleardir, "KrystalDanceEdition/Content/Anims")
		pcall(cleardir, "KrystalDanceEdition/Content/Sounds")
		pcall(cleardir, "KrystalDanceEdition/Content/Images")
		pcall(cleardir, "KrystalDanceEdition/Content/Models")
		pcall(cleardir, "KrystalDanceEdition/Content/Unknown")
...
--[[local function _getgithubraw(path)
	local s, resp = pcall(request, {
		Method = "GET",
		Url = "https://api.github.com/repos/STEVE-916-create/Krystal Dance Edition/contents/" .. path,
		Headers = {
			Accept = "application/vnd.github.VERSION.raw"
		}
	})
	...
	s, resp = pcall(request, {
		Method = "GET",
		Url = "https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/" .. path,
	})
	if s and resp and resp.StatusCode == 200 then
		return resp.Body
	end
...
local function GetMarketList()
	...
	if not aitemus or not file2name or not file2aitemu then
		local marketteresult = game:HttpGet("https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/community/list.txt")
		...
		for _,a in marketteresult do
			if #a > 3 then
				...
				if k == "file" then
					aitemu.Source = "https://raw.githubusercontent.com/STEVE-916-create/Krystal Dance Edition/main/community/" .. v
...
local function RefreshOnlineUserModules()
	...
	for _,aitemu in aitemus do
		...
		Util.LinkDestroyI2C(item, item.Activated:Connect(function()
			...
			local path = "KrystalDanceEdition/Modules/" .. aitemu.File
			if isfile(path) then
