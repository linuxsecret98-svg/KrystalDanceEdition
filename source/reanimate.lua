...
-- ══════════════════════════════════════════════════════════════
--  MRXH UPGRADE: Animation Track Sweeper
--  Stops all game animation tracks on Player.Character every
--  frame so reanimate pose is visible to others on the server.
--  Uses simple polling only — no hooks that can break UI/clicks.
-- ══════════════════════════════════════════════════════════════
...
function AnimTrackKiller.SweepCharacter(character)
	...
	-- Stop via all Animators found anywhere in character
	pcall(function()
	...
	-- Also stop via Humanoid directly as fallback
	pcall(function()
